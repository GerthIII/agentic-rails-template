...
# docker build -t agentic_rails_template .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name agentic_rails_template agentic_rails_template
